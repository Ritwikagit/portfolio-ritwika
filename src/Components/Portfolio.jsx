...
const projectList = [
  ...
  },
  {
    title: "Quiz Game",
    description:
      "Developed a dynamic quiz game app using HTML, CSS, and JavaScript, offering real-time feedback, time-based challenges, and seamless score updates for an engaging user experience.",
  ...
  },
  {
    title: "Pokemon Game",
    description:
      "Developed a Pokémon game using HTML, CSS, and JavaScript, where players engage in battles, with the more powerful character emerging victorious.",
